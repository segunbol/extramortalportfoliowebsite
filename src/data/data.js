export const portfolio = [
    ...
    export const techStack = ["Django","Node JS","MongoDB","React Native","React JS","PostGres","Docker","Git",]
    ...
    description: "In the rapidly evolving landscape of software development, building applications that can handle increasing user demand and scale seamlessly is crucial. One fundamental aspect that enables this scalability is server architecture. In this essay, we will explore the significance of server architecture in building robust and scalable systems, discussing key concepts, strategies, and technologies that empower software engineers to meet the ever-growing demands of modern applications.",
    article: "",
    project:"",
    },
    {
    title: "Data Processing and Analysis",
    description: "In the era of data-driven decision-making, the ability to extract valuable insights from vast amounts of information has become paramount. Data processing and analysis have emerged as indispensable tools for organizations across various industries, enabling them to uncover patterns, trends, and correlations that drive strategic actions and foster innovation. As a software engineer, my expertise lies in harnessing the power of data to empower insightful decision-making.",
    article: "",
    project:"",
    },
    {
    ...
    from:"2020",
    to:"2023",
    jobDescription:"Engaged in dynamic collaboration with a geographically dispersed team while serving as a Department / Team lead and backend engineer for our applications at The Concept Group. I contribute to the empowerment of our users by delivering customer-centric and intuitively accessible services. My role extends beyond conventional backend engineering; I actively participate in ideation workshops aimed at conceptualizing innovative functionalities. My leadership extends beyond technical proficiency, encompassing the strategic guidance of a dedicated team, ensuring alignment with organizational objectives, and continuously raising the bar for software engineering standards. My experience at The Concept Group reflects my commitment to pushing boundaries and achieving impactful results in the realm of backend software development.",
    achievements: ["Played a lead role / lead backend developer in developing RFS Brookers Portal (NodeJS, Microservices, Typescript, React, AWS, Elasticsearch)","Played a lead role in Development, Deployment and maintenance of Rosabon Finance Load Application APIs (spring boot, NodeJS nextJs, React, Flutter, unit/integration tests, Microservices, GitHub actions, Sentry, Docker, Ecosystem…)","Was the lead backend developer in designing and developing a Performance Management System (NodeJS, Typescript, React, TDD, Cypress)","Developed and maintained Staff Bus Application (Web portal / Mobile)","RFS COllection Portal (Python Django)",]
    },
    {
    ...
    from:"2018",
    to:"2020",
    jobDescription:"Engaged in dynamic collaboration with a geographically dispersed team while serving as a Department"
    },
